      ...
      >
        <div className="container">
          <div className={
            ...
            <Logo style={{ paddingTop: '25px', width: '80px', height: '80px' }} />
            {!hideNav &&
              <>
                <button
                  ref={hamburger}
                ...
                <nav 
                  ...
                  <div className="header-nav-inner" >
                    ...
                    {!hideSignin &&
                      ...
                      >
                        <li>
                          {/* <Link to="#0" style={{ backgroundColor: '#999900' }} className="button button-primary button-wide-mobile button-sm" onClick={closeMenu}>Sign In</Link> */}
                        </li>
                      </ul>}
                  </div>
                </nav>
